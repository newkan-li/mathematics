...
## 练习题答案与提示
1. (D)　2. (B)　3. (D)　4. (D)　5. (A)　6. (C)　7. (A)　8. (B)　9. (C)
10. (D)　11. (D)　12. (C)　13. (D)　14. (A)　15. (B)　16. (C)　17. (C)　18. (D)

19. $-\dfrac{1}{6}$；　20. $2$；　21. $e^{\frac{1}{2}}$；　22. $-\dfrac{1}{2}$；　23. $e^{\frac{n(n+1)}{2}}$；　24. $e^{-\frac{1}{6}}$；　25. $e^{\frac{1}{2}}$；

26. $\dfrac{2\sqrt{2}}{3}$；　27. $a = \dfrac{1}{2}, b = -\dfrac{1}{2}$；　28. $n = 2, a = 7$；　29. $n = 2, a = -2e^2$；

30. $a = 1, b = 0, c = \dfrac{1}{2}$；　31. $\dfrac{1}{6}$；　32. $\dfrac{1}{6}$；　33. $\dfrac{1}{3}$；　34. $\dfrac{1}{2}$；

35. (1) $e^{-\frac{1}{2}}$；　(2) $e^{\frac{1}{2}(n+1)}$；　(3) $e^{\frac{1}{3}}$；　(4) $e^4$.　36. (1) $1$；　(2) $e^{-1}$.

37. $f(0) = -1, f'(0) = 2, \lim\limits_{x \to 0} \dfrac{x}{f(x) + e^x} = \dfrac{1}{3}$.　38. $\dfrac{1}{3}$；　39. $\dfrac{\pi}{2}$；　40. $\dfrac{\pi}{4}$；
